...
@class GTMSessionFetcherSessionDelegateDispatcher, NSArray, NSDictionary, NSHTTPCookieStorage, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSOperationQueue, NSString, NSURLCredential, NSURLSessionConfiguration;
